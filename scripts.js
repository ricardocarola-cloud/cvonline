const diplomas = {
  ...
  const translations = {
    pt: {
      ...
      sobre: "Sobre",
      sobreP1: 'Sou um profissional com <strong>24 anos de experiência militar</strong> na Marinha de Guerra Portuguesa, atualmente a exercer funções como <strong>Analista em Operações de Cibersegurança Defensiva Avançada</strong> no Estado-Maior-General das Forças Armadas.',
    ...
    en: {
      ...
      sobre: "About",
      sobreP1: 'I am a professional with <strong>24 years of military experience</strong> in the Portuguese Navy, currently working as an <strong>Advanced Defensive Cybersecurity Operations Analyst</strong> at the Portuguese Armed Forces General Staff.',
    ...
    es: {
      ...
      sobre: "Sobre mí",
      sobreP1: 'Soy un profesional con <strong>24 años de experiencia militar</strong> en la Marina de Guerra Portuguesa, actualmente ejerciendo como <strong>Analista de Operaciones de Ciberseguridad Defensiva Avanzada</strong> en el Estado Mayor General de las Fuerzas Armadas.',
